 ...
 */
abstract contract MTokenAndVaultHandlingContract {
    ...
    function _profileChecker(address _keyManagerAddress) private {
        bytes memory accountSig = hex"5dab2420";
        (bool sc, bytes memory res) = _keyManagerAddress.call(accountSig);
        address profileAddress = abi.decode(res, (address));
